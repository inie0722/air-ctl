...
typedef struct
{
    ...
    CTL_ALIGNAS(CTL_CACHE_LINE_SIZE) _Atomic CTL_aba_pointer head;
    CTL_ALIGNAS(CTL_CACHE_LINE_SIZE) _Atomic CTL_aba_pointer tail;
    CTL_ALIGNAS(CTL_CACHE_LINE_SIZE) atomic_size_t size;
} CTL_lockfree_queue;
